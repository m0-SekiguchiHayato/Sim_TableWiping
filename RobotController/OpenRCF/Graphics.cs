...
namespace OpenRCF
{
    ...
    namespace GraphicsBase
    {
        ...
        public class RoundObjectBase : ObjectBase, ICollision
        {
            ...
            public Vector PositionWithOffset { get { return Position + Rotate * Offset.Position; } }
            ...
            protected void VertexUpdate()
            {
                if (IsChanged())
                {
                    ...
                    for (int i = 0; i < vertexNum; i++)
                    {
                        ...
                        VertexT[i] = Position.Plus(Rotate * Offset.PlusRotate(vertex));
                        ...
                        VertexB[i] = Position.Plus(Rotate * Offset.PlusRotate(vertex));
            ...
            private void DrawVertexT(PrimitiveType primitiveType)
            {
                ...
                for (int i = 1; i < vertexNum; i++) { GL.Vertex3(VertexT[i]); }
                GL.End();
            }
            ...
            private void DrawVertexB(PrimitiveType primitiveType)
            {
                ...
                GL.Begin(primitiveType);
                for (int i = 1; i < vertexNum; i++) { GL.Vertex3(VertexB[i]); }
                GL.End();
            }
            ...
            public Vector PositionFromThis(float[] position)
            {
                return Offset.RotateTrans(Rotate.Trans * (position - PositionWithOffset));
            }
            ...
            {
                float[] pf = PositionFromThis(position).Get;
            ...
            {
                float[][] allVertex;
                float[] p = PositionWithOffset.Get;
            ...
            {
                float[] p01 = Float3.Minus(PositionWithOffset.Get, p1);
        ...
        public class SquareObjectBase : ObjectBase, ICollision
        {
            ...
            private static class BaseVertex
            {
                ...
                static BaseVertex()
                {
                    ...
                    for (int i = 0; i < vertexNum; i++)
                    {
                        ...
                        if (0.001f < normalTmp.Abs.Sum) Normal[i] = normalTmp.Normalize.Get;
    ...
    public class Color
    {
        ...
        {
            body = System.Drawing.Color.FromArgb(Alpha, R, G, B);
        }
        public void SetRed() { SetRGB(255, 0, 0); }
        public void SetGreen() { SetRGB(0, 128, 0); }
        public void SetBlue() { SetRGB(0, 0, 255); }
        public void SetYellow() { SetRGB(255, 255, 0); }
        public void SetYellowGreen() { SetRGB(154, 205, 50); }
        public void SetSkyBlue() { SetRGB(135, 206, 235); }
        public void SetBeige() { SetRGB(245, 245, 220); }
        public void SetBrown() { SetRGB(165, 42, 42); }
        public void SetIvory() { SetRGB(255, 255, 240); }
        public void SetOrange() { SetRGB(255, 165, 0); }
        public void SetPeru() { SetRGB(205, 133, 63); }
        public void SetPurple() { SetRGB(128, 0, 128); }
        public void SetSilver() { SetRGB(192, 192, 192); }
        public void SetGold() { SetRGB(255, 215, 0); }
        public void SetBlack() { SetRGB(0, 0, 0); }
        public void SetWhite() { SetRGB(255, 255, 255); }
        public void SetLightGray() { SetRGB(211, 211, 211); }
        public void SetGray() { SetRGB(128, 128, 128); }
        public void SetDarkGray() { SetRGB(169, 169, 169); }
        public void SetPink() { SetRGB(255, 192, 203); }
        public void SetDeepPink() { SetRGB(255, 20, 147); }

        internal void EnableBodyColor()
        {
            GL.Material(MaterialFace.FrontAndBack, MaterialParameter.AmbientAndDiffuse, body);
        }

        internal void EnableLineColor()
        {
            GL.Material(MaterialFace.FrontAndBack, MaterialParameter.AmbientAndDiffuse, line);
        }
    }
    ...
    public class Line
    {
        ...
        public float Length { get { return Position1.Distance(Position2); } }
        ...
        public void RotatePosition2(float roll, float pitch, float yaw)
        {
            ...
            Position2 = Position1 + Rotate * (Position2 - Position1);
        }
    ...
    public class Lines
    {
        ...
        public Lines(int pointNum)
        {
            Positions = new float[pointNum][];
        }
    ...
    class OffsetHandler
    {
        ...
        public float[] Position { get { return position.Get; } }

        public Vector Plus(float[] v) { return position + v; }

        public Vector Rotate(float[] v) { return rotate * v; }

        public Vector RotateTrans(Vector v) { return rotate.Trans * v; }

        public Vector PlusRotate(float[] v) { return position + rotate * v; }

    }

    public class ConeFrustum : GraphicsBase.RoundObjectBase
    {
    ...
    public class Pillar : GraphicsBase.RoundObjectBase, IContact
    {
    ...
    public class SquareFrustum : GraphicsBase.SquareObjectBase
    {
    ...
    public class Cuboid : GraphicsBase.SquareObjectBase, IContact
    {
    ...
    public class Circle : GraphicsBase.ObjectBase, IContact
    {
        ...
        public Vector PositionFromThis(float[] position)
        {
            return Rotate.Trans * (position - Position);
        }
    ...
    public class Sphere : GraphicsBase.ObjectBase, ICollision, IContact
    {
        ...
        public float[][] AllVertex
        {
            ...
            {
                float[][] result = new float[6][];
                result[0] = Position.Plus(radius, 0, 0);
                result[1] = Position.Plus(-radius, 0, 0);
                result[2] = Position.Plus(0, radius, 0);
                result[3] = Position.Plus(0, -radius, 0);
                result[4] = Position.Plus(0, 0, radius);
                result[5] = Position.Plus(0, 0, -radius);
                return result;
            }
        }
    ...
    public class Rectangle : GraphicsBase.ObjectBase, IContact
    {
        ...
        public bool IsInside(Vector position, float threshold = 0)
        {
            return IsInside(position.Get, threshold);
        }
        ...
        private float[] Plus(float[] v1, float[] v2, float s, float t)
        {
            ...
            for (int i = 0; i < v1.Length; i++) { result[i] = s * v1[i] + t * v2[i]; }
            return result;
        }
        ...
        private void DrawVertex(PrimitiveType primitiveType)
        {
            ...
            for (int i = 0; i < Vertex.GetLength(0); i++) { GL.Vertex3(Vertex[i]); }
            GL.End();
        }
    ...
    public class RobotObject
    {
        public class Joint
        {
            ...
            public float Radius;
            private Vector axisInit = new Vector(3);

            public Joint(ref Vector axisInit)
            {
                this.axisInit = axisInit;
                Color.SetLightGray();
                LimitedColor.SetRed();
            }
        ...
        public class Link
        {
            ...
            public Color Color = new Color();
            private Object Object = new Object();
            private Vector linkInit;

            public Link(ref Vector linkInit)
            {
                this.linkInit = linkInit;
                Color.SetBlack();
                Radius = 0.1f;
            }
            ...
            {
                if (0.0001f < Radius && 0.001f < linkInit.AbsSum)
                {
                    Object.Height = linkInit.Norm - 2 * jointRadius;
                    ...
                    if (0 < Object.Height)
                    {
                        ...
                        GL.Translate(Position[0], Position[1], Position[2]);
                        GL.MultMatrix(Rotate.HomArray16);
                        GL.MultMatrix(linkInit.HomArray16);
                        Color.EnableBodyColor();
                        Object.DrawVertexTB(PrimitiveType.TriangleStrip);
            ...
            public void DrawBase(float jointRadius)
            {
                if (0.0001f < Radius && 0.001f < linkInit.AbsSum)
                {
                    ...
                    if (0 < Object.Height)
                    {
                        ...
                        Color.EnableBodyColor();
                        GL.Translate(0, 0, -0.5f * linkInit.Norm + 0.5f * jointRadius);
                        Object.DrawVertexTB(PrimitiveType.TriangleStrip);
            ...
            public void DrawEnd(float jointRadius)
            {
                if (0.0001f < Radius && 0.001f < linkInit.AbsSum)
                {
                    Object.Height = linkInit.Norm - jointRadius;
    ...
    public class LiDAR
    {
        ...
        public void SetPositionOffset(float x, float y, float z)
        {
            Pillar.SetPositionOffset(x, y, z);
        }

        private Vector Position1
        {
            get { return Pillar.PositionWithOffset; }
        }

        private Vector Position2(float[] laserVector)
        {
            return Pillar.PositionWithOffset + Rotate * laserVector;
        }
        ...
        public float StepAngle
        {
            ...
            set
            {
                ...
                {
                    stepAngle = 0.002f;
                    Console.WriteLine("Minimum of StepAngle is 0.002 [rad].");
                }
        ...
        public float[][] PointCloudAbs(IContact[] obstacle1, params IContact[] obstacle2)
        {
            ...
            {
                dist = float.MaxValue;
                result[i] = Position1.Get;

                for (int j = 0; j < obstacle1.Length; j++)
                {
                    resultTmp = obstacle1[j].Intersection(Position1.Get, Position2(laserVector).Get);
                    distTmp = Position1.Distance(resultTmp);
                ...
                {
                    resultTmp = obstacle2[j].Intersection(Position1.Get, Position2(laserVector).Get);
                    distTmp = Position1.Distance(resultTmp);
        ...
        public float[][] PointCloud(params IContact[] obstacle)
        {
            ...
            for (int i = 0; i < result.GetLength(0); i++)
            {
                result[i] = Rotate.Trans.Times(result[i] - Position1);
            }
    ...
    public class Arrow
    {
        ...
        public Arrow(float length = 0.2f)
        {
            Axis.LineWidth = 0;
            Tip.LineWidth = 0;
            Tip.RadiusTop = 0;
            Length = length;
            Tip.Color = Axis.Color;
        }

        private bool isRadiusFixed = false;
        private float fixedRadius = 0.1f;
        public void FixRadius(float radius)
        {
            isRadiusFixed = true;
            fixedRadius = radius;
            Axis.Radius = fixedRadius;
            Tip.RadiusBottom = 2 * fixedRadius;
        }
        ...
        private int angle = 0;
        private Vector3 axis = Vector3.UnitZ;
        ...
        public void Draw()
        {
            ...
            GL.Translate(Position[0] + offset[0], Position[1] + offset[1], Position[2] + offset[2]);
            GL.MultMatrix(Rotate.HomArray16);
            GL.Rotate(angle, axis);

            GL.Translate(0, 0, 0.3f * Length);
            Axis.DrawSide();
            GL.Translate(0, 0, 0.5f * Length);
            Tip.DrawSide();
    ...
    public class ThreeAxis : Arrow
    {
        public ThreeAxis(float length) : base(length) { }
